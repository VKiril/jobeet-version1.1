...
class JobControllerTest extends WebTestCase
{
    ...
    public function testJobForm()
    {
        ...
        $query = $em->createQuery('
                                  SELECT count(j.id) from IbwJobeetBundle:Job j WHERE
                                  j.location = :location AND j.is_activated IS NULL AND j.is_public = 0');
    ...
    public function testPublishJob()
    {
        ...
        $query = $em->createQuery('SELECT count(j.id) from IbwJobeetBundle:Job j
